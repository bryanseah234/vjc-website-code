...
{if('load_more'==this.settings.pagination&&this.totalPages==this.currPage){$(this.nodeClass+' .fl-builder-pagination-load-more').remove();}}};})(jQuery);(function($){$(function(){new FLBuilderPostGrid({id:'5e1ebb0dbaca5',layout:'feed',pagination:'numbers',postSpacing:'60',postWidth:'300',matchHeight:0,isRTL:false});});})(jQuery);